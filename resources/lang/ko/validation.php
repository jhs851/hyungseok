...
return [
    ...
    */
    ...
    'before_or_equal' => ':attribute 는 :date 이전 날짜여야 합니다.',
    'between' => [
    ...
    'date_equals' => ':attribute 값은 :date 와 같은 날짜여야 합니다.',
    ...
    'file' => ':attribute 값은 파일이어야 합니다.',
    'filled' => ':attribute 값이 누락되었습니다.',
    'gt' => [
        'numeric' => ':attribute 값은 :value보다 커야 합니다.',
        'file' => ':attribute 값은 :value 킬로바이트보다 커야 합니다.',
        'string' => ':attribute 값은 :value 문자보다 커야 합니다.',
        'array' => ':attribute 값은 :value 항목을 초과해야 합니다.',
    ],
    'gte' => [
        'numeric' => ':attribute 값은 :value보다 크거나 같아야 합니다.',
        'file' => ':attribute 값은 :value 킬로바이트보다 크거나 같아야 합니다.',
        'string' => ':attribute 값은 :value 문자보다 크거나 같아야 합니다.',
        'array' => ':attribute 값은 :value 항목 이상이 있어야 합니다.',
    ],
    ...
    'ipv4' => ':attribute 값이 유효한 IP4 주소가 아닙니다.',
    'ipv6' => ':attribute 값이 유효한 IP6 주소가 아닙니다.',
    'json' => ':attribute 값이 유효한 JSON 문자열이 아닙니다.',
    'lt' => [
        'numeric' => ':attribute 값은 :value보다 작아야 합니다.',
        'file' => ':attribute 값은 :value 킬로바이트보다 작아야 합니다.',
        'string' => ':attribute 값은 :value 문자보다 작아야 합니다.',
        'array' => ':attribute 값은 :value 항목보다 미만이어야 합니다.',
    ],
    'lte' => [
        'numeric' => ':attribute 값은 :value보다 작거나 같아야 합니다.',
        'file' => ':attribute 값은 :value 킬로바이트보다 작거나 같아야 합니다.',
        'string' => ':attribute 값은 :value 문자보다 작거나 같아야 합니다.',
        'array' => ':attribute 값은 :value 항목 이하로 있어야 합니다.',
    ],
    'max' => [
    ...
    'mimetypes' => ':attribute 값ㅅ이 :values 형식의 파일이어야 합니다.',
    'min' => [
