                                ...
                                <table class="table table-hover text-center h5 font-weight-light">
                                        ...
                                        <tr>
                                            <th scope="col">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="parent-checkbox">
                                                    <label class="custom-control-label" for="parent-checkbox"></label>
                                                </div>
                                            </th>
                                            <th scope="col">ID</th>
                                    ...
                                    <tbody>
                                        <tr v-for="development in items" :key="development.id">
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" :id="`children-checkbox-${development.id}`">
                                                    <label class="custom-control-label" :for="`children-checkbox-${development.id}`"></label>
                                                </div>
                                            </td>
